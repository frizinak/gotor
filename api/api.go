...
func (s Status) Evaluate() (string, Evaluation) {
	...
	case s.And(StatusError | StatusVerifyQueue):
		return statusNames[StatusVerifyQueue], Bad
	case s.And(StatusVerify):
		return statusNames[StatusVerify], Good
	case s.And(StatusVerifyQueue):
		return statusNames[StatusVerifyQueue], Good
